      ...
      <div className="w-full max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center py-4 flex-wrap gap-4">
          <div className="flex space-x-2">
            <button onClick={() => handleSortChange("all")} className={`px-4 py-2 rounded text-sm hover:bg-[#ffbb00] hover:text-black ${sortStatus === "all" ? "bg-[#FFD700] text-black" : "bg-[#444] text-white"}`}>Alle</button>
            <button onClick={() => handleSortChange("Under behandling")} className={`px-4 py-2 rounded text-sm hover:bg-[#ffbb00] hover:text-black ${sortStatus === "Under behandling" ? "bg-[#FFD700] text-black" : "bg-[#444] text-white"}`}>Under behandling</button>
            <button onClick={() => handleSortChange("Ferdig")} className={`px-4 py-2 rounded text-sm hover:bg-[#ffbb00] hover:text-black ${sortStatus === "Ferdig" ? "bg-[#FFD700] text-black" : "bg-[#444] text-white"}`}>Ferdig</button>
          </div>
